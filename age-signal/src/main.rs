//! Unified D-Bus system daemon: `org.archparentalcontrols.ParentalDaemon`
//!
//! Combines two interfaces:
//! - `org.archparentalcontrols.AgeSignal1`    — age range of the calling user
//! - `org.archparentalcontrols.ParentalMonitor1` — process monitoring for supervised users
//!
...
const DATA_DIR: &str = "/var/lib/arch-parental-controls";
const ACTIVITY_DIR: &str = "/var/lib/arch-parental-controls/activity";
const MONITORED_FILE: &str = "/var/lib/arch-parental-controls/monitored-users.json";
const TIME_LIMITS_FILE: &str = "/var/lib/arch-parental-controls/time-limits.json";
const TIME_USAGE_FILE: &str = "/var/lib/arch-parental-controls/time-state.json";
...
const USER_PROFILES_FILE: &str = "/var/lib/arch-parental-controls/user-profiles.json";
...
#[interface(name = "org.archparentalcontrols.AgeSignal1")]
impl AgeSignal {
...
#[interface(name = "org.archparentalcontrols.ParentalMonitor1")]
...
async fn main() -> Result<()> {
    ...
    connection
        .object_server()
        .at("/org/archparentalcontrols/ParentalDaemon", age_signal)
        .await?;
    ...
    connection
        .object_server()
        .at("/org/archparentalcontrols/ParentalDaemon", monitor)
        .await?;

    // Request bus name
    connection
        .request_name("org.archparentalcontrols.ParentalDaemon")
        .await?;
