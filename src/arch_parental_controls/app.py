"""GTK Application class for Arch Parental Controls."""
...
from arch_parental_controls.core.constants import (
    APP_DEVELOPER,
    APP_ID,
    APP_NAME,
    APP_VERSION,
...
class ParentalControlsApp(Adw.Application):
    ...
    def do_activate(self) -> None:
        from arch_parental_controls.window import MainWindow
    ...
    def _on_about(self, _action: Gio.SimpleAction, _param: object) -> None:
        dialog = Adw.AboutDialog(
            ...
            application_icon="arch-parental-controls",
