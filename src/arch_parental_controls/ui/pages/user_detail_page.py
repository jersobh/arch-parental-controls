...
from arch_parental_controls.ui.compliance import (
    confirm_delete_data,
    show_consent_dialog,
    start_export_data,
)
from arch_parental_controls.ui.widgets.activity_block import ActivityBlock
from arch_parental_controls.utils.async_runner import run_async
from arch_parental_controls.utils.i18n import setup_i18n

_ = setup_i18n()

_USER_PROFILES_FILE = "/var/lib/arch-parental-controls/user-profiles.json"
