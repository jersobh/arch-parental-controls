...
from arch_parental_controls.services.accounts_service import AccountsServiceWrapper
from arch_parental_controls.utils.async_runner import run_async
from arch_parental_controls.utils.i18n import setup_i18n

_ = setup_i18n()

POLKIT_ACTION = "org.archparentalcontrols.parental-controls.manage-settings"
...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _on_auth_clicked(self, _btn: Gtk.Button) -> None:
        ...
        def authenticate() -> bool:
            pid = os.getpid()
            try:
                print(f"DEBUG: Checking polkit action: {POLKIT_ACTION}")
                subprocess.run(
                    [
                        "pkcheck",
    ...
    def _setup_supervised_navigation(self) -> None:
        ...
        from arch_parental_controls.ui.pages.supervised_view import (
            SupervisedView,
        )
    ...
    def _setup_admin_navigation(self) -> None:
        ...
        from arch_parental_controls.ui.pages.main_view import MainView
    ...
    def show_user_detail(self, user: object) -> None:
        ...
        if self._is_supervised:
            return
        from arch_parental_controls.ui.pages.user_detail_page import (
            UserDetailPage,
        )
    ...
    def show_time_limits(self, user: object) -> None:
        ...
        if self._is_supervised:
            return
        from arch_parental_controls.ui.pages.time_limits_page import (
            TimeLimitsPage,
        )
    ...
    def show_app_filter(self, user: object) -> None:
        ...
        if self._is_supervised:
            return
        from arch_parental_controls.ui.pages.app_filter_page import (
            AppFilterPage,
        )
    ...
    def show_dns_settings(self, user: object) -> None:
        ...
        if self._is_supervised:
            return
        from arch_parental_controls.ui.pages.dns_page import DnsPage
    ...
    def show_add_user(self) -> None:
        ...
        if self._is_supervised:
            return
        from arch_parental_controls.ui.pages.users_page import UsersPage
